...
const globalLibvipsVersion = function () {
  if (process.platform !== 'win32') {
    ...
    console.log('Running command to detect version:', `PKG_CONFIG_PATH="${pkgConfigPath()}" pkg-config --modversion vips-cpp`);
    console.log('Detected global vips version:', globalLibvipsVersion);
